...
最終目標はワークフローの作成ですが、まず、通常のジョブテンプレートを作成する必要があります。
  ...
  - **テンプレート** を選択し、緑色のプラスボタンをクリックして、**Job Template**を選択します
  ...
  - 上記の内容をアプリチームに対して繰り返します。**テンプレート** を選択し、緑色のプラスボタンをクリックして、**ジョブテンプレート**を選択します  
...
ジョブが完了した後、すべてがうまく働いたかどうかを確認するため、お使いの制御ホストからnode1、node2、node3へログインして以下を実行します。  
